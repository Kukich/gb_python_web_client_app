...
class Tests(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        self.ServerSocket.send_message(test_socket, self.test_dict_send)
        ...
        with self.assertRaises(Exception):
            self.ServerSocket.send_message(test_socket, test_socket)
    ...
    def test_get_message(self):
        ...
        self.assertEqual(self.ServerSocket.get_message(test_sock_ok), self.test_dict_recv_ok)
        # тест корректной расшифровки ошибочного словаря
        self.assertEqual(self.ServerSocket.get_message(test_sock_err), self.test_dict_recv_err)
